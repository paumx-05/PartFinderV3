// components/BeltTransmissionSubSubsections.tsx
'use client';
...
export default function BeltTransmissionSubSubsections({ 
  ...
  const currentSubSubcategory = beltTransmissionSubSubsections.find(subsub => subsub.id === activeSubSubcategory);
  ...
  return (
    <div className="space-y-6">
      ...
      <SubSubsectionHeader
        ...
        subcategoryName="Transmisión por correas"
      ...
      <SubSubCategoriesNavigation
        subsubcategories={beltTransmissionSubSubsections}
        activeSubSubcategory={activeSubSubcategory}
        onSubSubcategoryChange={handleSubSubcategoryChange}
      />

      {/* Filtros específicos para transmisión por correas */}
      <BeltTransmissionFilters
      ...
      <PartsToolbar
        category={{
          ...
          icon: 'Zap',
          description: 'Correas de distribución, poli V, trapezoidales, poleas de alternador, kits completos',
          parts: []
        }}
