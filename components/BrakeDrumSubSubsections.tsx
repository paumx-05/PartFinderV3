// components/BrakeDrumSubSubsections.tsx
'use client';
...
import BrakeDrumFilters from './BrakeDrumFilters';
import { brakeDrumSubSubsections } from '@/lib/mocks/brakeDrumSubSubsections';

interface BrakeDrumSubSubsectionsProps {
  vehicleData: {
    vin: string;
    brand: string;
    model: string;
...
export default function BrakeDrumSubSubsections({ 
  vehicleData, 
  onAddToCart, 
  cartItemsCount = 0,
  onBackToSubcategory
  ...
  const currentSubSubcategory = brakeDrumSubSubsections.find(subsub => subsub.id === activeSubSubcategory);
  ...
  return (
    <div className="space-y-6">
      ...
      <SubSubsectionHeader
        ...
        subcategoryName="Freno de tambor"
      ...
      <SubSubCategoriesNavigation
        subsubcategories={brakeDrumSubSubsections}
        activeSubSubcategory={activeSubSubcategory}
        onSubSubcategoryChange={handleSubSubcategoryChange}
      />

      {/* Filtros específicos para freno de tambor */}
      <BrakeDrumFilters
      ...
      <PartsToolbar
        category={{
          ...
          icon: 'Circle',
          description: 'Kits de frenos, cilindros de rueda, zapatas y tambores',
          parts: []
        }}
