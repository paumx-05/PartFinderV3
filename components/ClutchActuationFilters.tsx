// components/ClutchActuationFilters.tsx
'use client';
import React from 'react';
import { Filter, X } from 'lucide-react';

interface ClutchActuationFiltersProps {
...
const typeOptions = [
  ...
  { value: 'esclavo', label: 'Esclavo' },
  { value: 'hidráulico', label: 'Hidráulico' },
  { value: 'reforzado', label: 'Reforzado' },
  { value: 'original', label: 'Original' },
];

export default function ClutchActuationFilters({
  onBrandFilter,
  onTypeFilter,
  onClearFilters,
  activeBrand,
  activeType
}: ClutchActuationFiltersProps) {
    ...
    <div className="bg-gray-800 bg-opacity-70 rounded-lg p-4 border-l-4 border-red-600">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2">
          ...
          <h4 className="text-lg font-bold text-red-600">Filtros de Accionamiento</h4>
        </div>
        {hasActiveFilters && (
          <button
