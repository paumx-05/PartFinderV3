// components/AirSystemFilters.tsx
'use client';
import React from 'react';
import { Filter, X } from 'lucide-react';

interface AirSystemFiltersProps {
...
export default function AirSystemFilters({
  onBrandFilter,
  onMaterialFilter,
  onClearFilters,
  activeBrand,
  activeMaterial,
}: AirSystemFiltersProps) {
    ...
    <div className="bg-gray-800 bg-opacity-70 rounded-lg p-4 border-l-4 border-red-600">
      <div className="flex items-center justify-between mb-4">
        <h5 className="text-sm font-bold text-red-600 flex items-center space-x-2">
          ...
          <span>Filtros de Alimentación de Aire</span>
        </h5>
        {hasActiveFilters && (
          <button
