// components/MainFiltersSubsections.tsx
'use client';
...
export default function MainFiltersSubsections({ 
  ...
  const currentSubSubcategory = mainFiltersSubsections.find(subsub => subsub.id === activeSubSubcategory);
