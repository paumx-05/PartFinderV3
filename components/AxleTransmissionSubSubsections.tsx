// components/AxleTransmissionSubSubsections.tsx
'use client';
...
export default function AxleTransmissionSubSubsections({ 
  ...
  const currentSubSubcategory = axleTransmissionSubSubsections.find(subsub => subsub.id === activeSubSubcategory);
  ...
  return (
    <div className="space-y-6">
      ...
      <SubSubsectionHeader
        ...
        subcategoryName="Transmisión por ejes"
      ...
      <SubSubCategoriesNavigation
        subsubcategories={axleTransmissionSubSubsections}
        activeSubSubcategory={activeSubSubcategory}
        onSubSubcategoryChange={handleSubSubcategoryChange}
      />

      {/* Filtros específicos para transmisión por ejes */}
      <AxleTransmissionFilters
      ...
      <PartsToolbar
        category={{
          ...
          icon: 'RotateCcw',
          description: 'Árboles de transmisión, palieres, articulaciones, fuelles, diferenciales, retenes',
          parts: []
        }}
