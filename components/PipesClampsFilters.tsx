// components/PipesClampsFilters.tsx
'use client';
import React from 'react';
import { Filter, X } from 'lucide-react';

interface PipesClampsFiltersProps {
...
export default function PipesClampsFilters({
  onBrandFilter,
  onMaterialFilter,
  onClearFilters,
  activeBrand,
  activeMaterial
}: PipesClampsFiltersProps) {
    ...
    <div className="bg-gray-800 bg-opacity-70 rounded-lg p-4 border-l-4 border-red-600">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2">
          ...
          <h4 className="text-lg font-bold text-red-600">Filtros de Tubería y Sujección</h4>
        </div>
        {hasActiveFilters && (
          <button
